...
local function Notify(text, title, duration)
	...
	frame.BackgroundColor3 = Color3.fromRGB(80,170,255)
...
Notify("Welcome to C00lClanv3!", "Have fun!", 3)
-- Main frame
...
titleBar.BackgroundColor3 = Color3.fromRGB(20,20,90)
...
leftCat.BackgroundColor3  = Color3.fromRGB(80,170,255)
